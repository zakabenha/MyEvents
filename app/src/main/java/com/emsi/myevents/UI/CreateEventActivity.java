...
public class CreateEventActivity extends AppCompatActivity {
    ...
    protected DatabaseReference dbOrga = FirebaseDatabase.getInstance().getReference("Organisateurs");
    protected String eventOrga;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventOrga = getIntent().getStringExtra("orgaId");
        ...
        ArrayAdapter<CharSequence> tmpAdapterEventTypes = ArrayAdapter.createFromResource(this,R.array.eventTypes, android.R.layout.simple_spinner_item);        tmpAdapterEventTypes.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
